const Scripts = () => ({
  ...
  bots: {
    ...
    icareMember: {
      ...
      status: "ctx._source.status = ctx._source.is_active == 1 ? 'active' : 'inactive'",
      icmAppActivated: "ctx._source.icm_app_activated = false",
      isActive: "ctx._source.remove(\"is_active\")",
